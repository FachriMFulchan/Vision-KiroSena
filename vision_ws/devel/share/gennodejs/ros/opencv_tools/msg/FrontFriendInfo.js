...
class FrontFriendInfo {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FrontFriendInfo(null);
  ...
  static datatype() {
    ...
    return 'opencv_tools/FrontFriendInfo';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FrontFriendInfo(null);
...
module.exports = FrontFriendInfo;
