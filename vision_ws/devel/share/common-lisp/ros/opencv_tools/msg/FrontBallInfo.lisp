...
(cl:defmethod cl:initialize-instance :after ((m <FrontBallInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FrontBallInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opencv_tools-msg:<FrontBallInfo> is deprecated: use opencv_tools-msg:FrontBallInfo instead.")))
...
(cl:defmethod radius-val ((m <FrontBallInfo>))
...
(cl:defmethod angle-val ((m <FrontBallInfo>))
...
(cl:defmethod x_pos-val ((m <FrontBallInfo>))
...
(cl:defmethod y_pos-val ((m <FrontBallInfo>))
...
(cl:defmethod distance-val ((m <FrontBallInfo>))
