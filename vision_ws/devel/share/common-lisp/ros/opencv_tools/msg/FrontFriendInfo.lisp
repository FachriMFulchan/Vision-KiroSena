...
(cl:defclass <FrontFriendInfo> (roslisp-msg-protocol:ros-message)
  ((Header
    :reader Header
    :initarg :Header
...
(cl:defclass FrontFriendInfo (<FrontFriendInfo>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <FrontFriendInfo>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'FrontFriendInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opencv_tools-msg:<FrontFriendInfo> is deprecated: use opencv_tools-msg:FrontFriendInfo instead.")))

(cl:ensure-generic-function 'Header-val :lambda-list '(m))
(cl:defmethod Header-val ((m <FrontFriendInfo>))
...
(cl:defmethod radius-val ((m <FrontFriendInfo>))
...
(cl:defmethod angle-val ((m <FrontFriendInfo>))
...
(cl:defmethod pos_known-val ((m <FrontFriendInfo>))
...
(cl:defmethod x_pos-val ((m <FrontFriendInfo>))
...
(cl:defmethod y_pos-val ((m <FrontFriendInfo>))
...
(cl:defmethod distance-val ((m <FrontFriendInfo>))
  ...
  (distance m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <FrontFriendInfo>) ostream)
  "Serializes a message object of type '<FrontFriendInfo>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FrontFriendInfo>) istream)
  "Deserializes a message object of type '<FrontFriendInfo>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FrontFriendInfo>)))
  "Returns string type for a message object of type '<FrontFriendInfo>"
  "opencv_tools/FrontFriendInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FrontFriendInfo)))
  "Returns string type for a message object of type 'FrontFriendInfo"
  "opencv_tools/FrontFriendInfo")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FrontFriendInfo>)))
  "Returns md5sum for a message object of type '<FrontFriendInfo>"
  "e12555c6777f103b129b21a823dbf452")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FrontFriendInfo)))
  "Returns md5sum for a message object of type 'FrontFriendInfo"
  "e12555c6777f103b129b21a823dbf452")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FrontFriendInfo>)))
  "Returns full string definition for message of type '<FrontFriendInfo>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FrontFriendInfo)))
  "Returns full string definition for message of type 'FrontFriendInfo"
  (cl:format cl:nil "Header Header~%float32 radius~%float32 angle~%bool pos_known~%~%int32 x_pos~%int32 y_pos~%float32 distance~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <FrontFriendInfo>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <FrontFriendInfo>))
  "Converts a ROS message object to a list"
  (cl:list 'FrontFriendInfo
