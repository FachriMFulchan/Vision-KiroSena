...
;//! \htmlinclude FrontInfo.msg.html

(cl:defclass <FrontInfo> (roslisp-msg-protocol:ros-message)
  ((Header
    :reader Header
    :initarg :Header
...
(cl:defclass FrontInfo (<FrontInfo>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <FrontInfo>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'FrontInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opencv_tools-msg:<FrontInfo> is deprecated: use opencv_tools-msg:FrontInfo instead.")))

(cl:ensure-generic-function 'Header-val :lambda-list '(m))
(cl:defmethod Header-val ((m <FrontInfo>))
...
(cl:defmethod radius-val ((m <FrontInfo>))
...
(cl:defmethod angle-val ((m <FrontInfo>))
...
(cl:defmethod pos_known-val ((m <FrontInfo>))
...
(cl:defmethod x_pos-val ((m <FrontInfo>))
...
(cl:defmethod y_pos-val ((m <FrontInfo>))
...
(cl:defmethod distance-val ((m <FrontInfo>))
  ...
  (distance m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <FrontInfo>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FrontInfo>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FrontInfo>)))
  "Returns string type for a message object of type '<FrontInfo>"
  "opencv_tools/FrontInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FrontInfo)))
  "Returns string type for a message object of type 'FrontInfo"
  "opencv_tools/FrontInfo")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FrontInfo>)))
  "Returns md5sum for a message object of type '<FrontInfo>"
  "e12555c6777f103b129b21a823dbf452")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FrontInfo)))
  "Returns md5sum for a message object of type 'FrontInfo"
  "e12555c6777f103b129b21a823dbf452")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FrontInfo>)))
  "Returns full string definition for message of type '<FrontInfo>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FrontInfo)))
  "Returns full string definition for message of type 'FrontInfo"
  (cl:format cl:nil "Header Header~%float32 radius~%float32 angle~%bool pos_known~%~%int32 x_pos~%int32 y_pos~%float32 distance~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <FrontInfo>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <FrontInfo>))
